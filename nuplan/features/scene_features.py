...
def _build_mini_scenarios(data_root: str, map_root: str, limit: int) -> List["AbstractScenario"]:
...
def main(argv: Optional[List[str]] = None) -> None:
    ...
    parser.add_argument(
        "--out-dir",
        type=str,
        default="/scratch/$USER/av-policy-lab/features",
    ...
    extractor = SceneFeatureExtractor()
    scenarios = _build_mini_scenarios(args.data_root, args.map_root, args.limit or 10_000_000)
